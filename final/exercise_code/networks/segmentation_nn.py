...
class SegmentationNN(pl.LightningModule):
    ...
    def __init__(self, num_classes=101, hparams=None):
        ...
        self.conv6 = nn.ConvTranspose2d(128, 256, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.conv7 = nn.ConvTranspose2d(256, num_classes, kernel_size=3, stride=2, padding=1, output_padding=1)
