...
temp2 = []
for i in range(102):
    temp1.append(random.randint(0, 150))
    temp2.append(random.randint(0, 150))
...
def label_img_to_rgb(label_img):
    ...
    for l in labels:
        mask = label_img == l
        label_img_rgb[mask] = [l, temp1[l+1], temp2[l+1]]
...
class SegmentationData(data.Dataset):
    ...
    def get_item_from_index(self, index):
        ...
        image_resize = transforms.Resize((240, 240))
